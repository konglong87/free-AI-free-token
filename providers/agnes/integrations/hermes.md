...
官网常见接入文档列出 HermesAgents 接入方法，待本地实测。
...
2. 选择 HermesAgents 接入方法。
3. 确认 Hermes 的 provider / model 配置格式。
4. 填写 Agnes AI API key、Base URL、model。
5. 运行最小 prompt。
...
| --- | --- | --- | --- | --- |
| 2026-06-24 | 待实测 | `agnes-2.0-flash` | 待核验 | 官网常见接入文档列出 HermesAgents |
